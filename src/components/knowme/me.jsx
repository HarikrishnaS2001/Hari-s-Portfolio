    ...
    <div>
                  ...
                  <div className="music gochi">
                    <div className="d-flex flex-column justify-content-between  align-items-stretch h-100">
                      <div className="h-100">
                        ...
                        <i class="fa fa-heart"></i>. From the timeless classics
                        of Ilaiyaraaja
      ...
      <div className="mview">
        <div className="scontent">
          ...
          <div className="mimagecontainer">
            <img src={comic1} alt="comic1" className="comic1" />
          </div>
          <div className="msports gochi">
            <div>Football❤️</div>
            <img src={comic5} alt="comic5" height="90%" width="85%" />
          </div>
          ...
          <div className="mtravel d-flex flex-row">
            <div
              className="d-flex flex-column h-100 w-50"
              style={{ backgroundColor: "black" }}
            >
